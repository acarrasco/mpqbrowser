...
power_trait(aggresive_recon, steal_ap, [yellow, blue, red, green, black, purple], []).
...
power_trait(take_aim, create_critical, [targeted, basic, protect], []).

power(hawkeye, classic, arrow_stab, red, 7).
power_trait(arrow_stab, destroy_tiles, [targeted, row], []).
...
power_trait(unstoppable_crash, destroy_tiles, [random, basic, special], []).

power(juggernaut, classic, headbutt, red, 6).
power_trait(headbutt, direct_damage, [target_enemy, self], []).
...
power_trait(spectacular_strategy, create_critical, [random, basic], []).
...
power_trait(lightning_strike, destroy_tiles, [random, basic, special], []).
...
power_trait(devour, destroy_tiles, [random, web_tiles], []).
...
power_trait(lethal_recon, steal_ap, [yellow, blue, red, green, black, purple], []).
...
power_trait(espionage, passive, [on_match], [purple, blue, black]).
power_trait(espionage, steal_ap, [purple, blue, black], []).
...
power_trait(murderous_aim, create_critical, [targeted, basic], []).
power_trait(murderous_aim, direct_damage, [target_enemy], []).

power(bullseye, dark_avengers, deadly_precission, green, 11).
power_trait(deadly_precission, destroy_tiles, [targeted, basic], []).
...
power_trait(sentinel_of_liberty, convert_tiles, [targeted, special, basic, enemy, friendly], [yellow]).
...
power_trait(star_spangled_avenger, convert_tiles, [targeted, special, basic, enemy, friendly], [countdown, friendly, red]).
...
power_trait(star_spangled_avenger, convert_tiles, [targeted, special, basic, enemy, friendly], [countdown, friendly, blue]).
...
power_trait(photonic_blasts, [destroy_tiles], [protect, random], []).

power(captain_marvel, ms_marvel, sonic_boom, black, 9).
power_trait(sonic_boom, direct_damage, [all_enemies], []).
power_trait(sonic_boom, create_special, [countdown, friendly, black], []).
...
power_trait(electric_arrow, create_special, [targeted, countdown, friendly, blue], []).

power(hawkeye, modern, blast_arrow, red, 9).
power_trait(blast_arrow, direct_damage, [all_enemies], []).
power_trait(blast_arrow, create_special, [targeted, countdown, friendly, red], []).

power(hawkeye, modern, speed_shot, purple, 0).
power_trait(speed_shot, passive, [on_match_5], []).
power_trait(speed_shot, direct_damage, [target_enemy], []).
power_trait(speed_shot, create_special, [random, countdown, friendly, purple], []).
...
power_trait(fireball, destroy_tiles, [random, red], []).
...
power_trait(inferno, drain_ap, [blue, purple, yellow]).
...
power_trait(iron_hammer, destroy_tiles, [random, area], []).
power_trait(iron_hammer, create_special, [countdown, friendly], []).

power(magneto, marvel_now, polarity_shift, purple, 9).
power_trait(polarity_shift, convert_tiles, [targeted, basic], [blue]).
power_trait(polarity_shift, convert_tiles, [random, basic], [red]).

power(magneto, marvel_now, magnetic_flux, red, 14).
power_trait(magnetic_flux, destroy_tiles, [random, block], []).
power_trait(magnetic_flux, generate_ap, [random], []).
power_trait(magnetic_flux, create_special, [countdown, friendly, red], []).
...
power_trait(gravity_warp, swap_tiles, [random, special], [targeted, basic]).
...
power_trait(web_slinger, convert_tiles, [random, special, basic], [web, locked]).
...
power_trait(lightning_storm, destroy_tiles, [random, basic, special], []).
...
power_trait(mjolnir_might, convert_tiles, [random, basic], [yellow]).

power(thor, marvel_now, thunder_strike, yellow, 12).
power_trait(thunder_strike, direct_damage, [target_enemy], []).
power_trait(thunder_strike, convert_tiles, [random, basic], [green]).
...
power_trait(aerial_superiority, create_special, [countdown, friendly, targeted], []).
power_trait(aerial_superiority, direct_damage, [target_enemy], []).
power_trait(aerial_superiority, deny_ap_gain, [targeted], []).
...
power_trait(mutagenic_breakthrough, create_special, [countdown, friendly, blue], []).
power_trait(mutagenic_breakthrough, create_special, [blue, strike, protect, attack, friendly], []).
power_trait(mutagenic_breakthrough, convert_tiles, [blue, basic], [blue, strike, protect, attack, friendly]).
...
power_trait(animal_inside, destroy_tiles, [random, basic], []).
...
power_trait(medical_marvel, create_special, [protect, friendly, blue], []).
power_trait(medical_marvel, convert_tiles, [random, basic, blue], [protect, friendly]).
...
power_trait(battleplan, create_special, [strike, friendly, yellow, random], []).
power_trait(battleplan, convert_tiles, [random, basic, yellow], [strike, friendly]).

power(black_panther, tchalla, defense_grid, blue, 8).
power_trait(defense_grid, create_special, [protect, friendly], []).
...
power_trait(sniper_rifle, destroy_tiles, [targeted, block, shape, special, basic], []).

power(black_widow, grey_suit, pistol, red, 14).
power_trait(pistol, direct_damage, [target_enemy], []).
power_trait(pistol, destroy_tiles, [targeted, block, square, special, basic], []).

power(black_widow, grey_suit, deceptive_tactics, purple, 11).
power_trait(deceptive_tactics, convert_tiles, [targeted, basic], [green]).
...
power_trait(nightstalker, create_special, [repeater, friendly, green, random], []).
power_trait(nightstalker, steal_ap, [enemy_strongest], []).

power(blade, daywalker, keep_your_enemies_closer, purple, 10).
power_trait(keep_your_enemies_closer, create_special, [attack, friendly, random, purple], []).
...
power_trait(the_thirst, create_special, [strike, friendly, random, red], []).
power_trait(the_thirst, convert_tiles, [basic, random, red], [strike, friendly]).
...
power_trait(lethal_improvisation, remove_special, [targeted, special], []).
power_trait(lethal_improvisation, convert_tiles, [targeted, special], [basic]).
...
power_trait(contract_killer, create_special, [strike, friendly, random], []).
power_trait(contract_killer, convert_tiles, [basic, random], [strike, friendly]).
...
power_trait(peacemaker_super_soldier, create_special, [countdown, friendly, targeted, blue], []).
power_trait(peacemaker_super_soldier, create_special, [protect, friendly, targeted, blue], []).
power_trait(peacemaker_super_soldier, convert_tiles, [targeted, sepecial, basic], [friendly, protect, blue]).
...
power_trait(energy_absoption, generate_ap, [red, black], []).
...
power_trait(immovable_object, move_to_front, [self, on_turn_start], []).
...
power_trait(fastball_special, fire_power, [random, selected_ally], []).
...
power_trait(mutant_revolutionary, convert_tiles, [team_up, random], [red]).
...
power_trait(radar_sense, remove_special, [enemy, random, strike, protect, attack], []).
power_trait(radar_sense, direct_damage, [target_enemy], []).
power_trait(radar_sense, amplified_by, [enemy, special], []).
...
power_trait(life_of_the_party, move_to_front, [self, on_allied_damaged], []).
...
power_trait(summon_demons, create_special, [attack, friendly, red], []).

power(doctor_doom, classic, technopathic_strike, blue, 9).
power_trait(technopathic_strike, convert_tiles, [blue, basic, random], [black]).
...
power_trait(manipulation, destroy_tiles, [enemy, random, attack, strike, protect], []).
...
power_trait(insult_to_injury, passive, [on_match], [special, enemy]).
power_trait(insult_to_injury, create_special, [attack, friendly, black], []).
power_trait(insult_to_injury, convert_tiles, [basic, black], [attack, friendly]).

power(doctor_octopus, otto_octavius, armed_and_dangerous, green, 12).
power_trait(armed_and_dangerous, direct_damage, [all_enemies], []).
power_trait(armed_and_dangerous, increase, [friendly, strike, protect, attack], []).
power_trait(armed_and_dangerous, stun, [random_enemy], []).
...
power_trait(crimson_bands_of_cyttorak, create_special, [targeted, countdown, friendly]).
...
power_trait(eye_of_agamotto, remove_special, [enemy, protect, attack, strike, invisibility, trap], []).
...
power_trait(double_double_cross, convert_tiles, [enemy, strike], [friendly]).
...
power_trait(crippling_blow, create_special, [countdown, friendly, red], []).
...
power_trait(raging_cajun, remove_special, [random, enemy, strike, protect, attack], []).
...
power_trait(stacked_deck, create_special, [charged, red, purple], []).
...
power_trait(bad_reputation, create_special, [strike, yellow], []).
...
power_trait(full_quiver, create_special, [countdown, friendly, blue], []).
...
power_trait(shou_lao_fang_strike, create_special, [strike, friendly, red], []).
power_trait(shou_lao_fang_strike, amplified_by, [black_ap], []).

power(iron_fist, immortal_weapon, iron_fist_of_kun_lun, purple, 5).
power_trait(iron_fist_of_kun_lun, convert_tiles, [random, basic], [black]).
...
power_trait(unibeam, drain_ap, [yellow, purple, black], []).

power(iron_man, model_40, ballistic_salvo, blue, 16).
power_trait(ballistic_salvo, direct_damage, [all_enemies], []).
power_trait(ballistic_salvo, destroy_tiles, [random, basic], []).
power_trait(ballistic_salvo, drain_ap, [yellow, purple, black], []).

power(iron_man, model_40, recharge, yellow, 6).
power_trait(recharge, create_special, [countdown, friendly, yellow], []).
power_trait(recharge, generate_ap, [red, blue, green, purple], []).
...
power_trait(inhuman_stretchiness, convert_tiles, [targeted, random, basic], [green]).
...
power_trait(trickery, steal_special, [strike, protect], []).
power_trait(trickery, convert_tiles, [enemy, strike], [friendly, protect]).
power_trait(trickery, convert_tiles, [enemy, protect], [friendly, strike]).

power(loki, dark_reign, illusions, purple, 5).
power_trait(illusions, swap_tiles, [random, colored], []).
...
power_trait(unbrekable, create_special, [protect, friendly, red], []).

power(luke_cage, hero_for_hire, jab_jab_cross, black, 6).
power_trait(jab_jab_cross, direct_damage, [target_enemy], []).
power_trait(jab_jab_cross, create_special, [countdown, friendly, black], []).
...
power_trait(coercive_field, create_special, [friendly, protect], []).
power_trait(coercive_field, convert_tiles, [random, basic, special], [friendly, protect]).
...
power_trait(magnetized_projectiles, swap_tiles, [random, red, blue], []).
...
power_trait(shapeshift, steal_ap, [green, yellow, red, blue, purple, black, team_up], []).

power(mystique, raven_darkholme, infiltration, blue, 10).
power_trait(infiltration, convert_tiles, [random, red, green, yellow], [purple, black]).
...
power_trait(masterstroke, reduce_enemy_ap, [red, green, yellow], []).
...
power_trait(psychic_knife, create_special, [strike, friendly, red], []).
...
power_trait(bewilder, increase, [friendly, strike, protect, attack], []).
...
power_trait(godlike_power, destroy_tiles, [random, column], []).

power(ragnarok, dark_avengers, thunderclap, red, 6).
power_trait(thunderclap, direct_damage, [target_enemy], []).
power_trait(thunderclap, convert_tiles, [random, basic], [blue]).
...
power_trait(blammo_we_got_ya, destroy_tiles, [random, block], []).
power_trait(blammo_we_got_ya, amplified_by, [green_ap], []).

power(rocket_and_groot, most_wanted, i_got_a_plan, blue, 11).
power_trait(i_got_a_plan, create_special, [countdown, friendly, blue], []).
power_trait(i_got_a_plan, create_special, [strike, friendly, blue], []).
power_trait(i_got_a_plan, convert_tiles, [basic, blue], [friendly, strike]).
...
power_trait(inspiration, increase, [friendly, random, protect, attack, strike], []).
...
power_trait(redwing, remove_special, [enemy, protect, attack, strike, countdown], []).
...
power_trait(reality_crush, stun, [random_enemy], []).

power(scarlet_witch, wanda_maximoff, hex_bolt, green, 8).
power_trait(hex_bolt, destroy_tiles, [targeted, random], []).
...
power_trait(arcane_incantation, create_special, [random, blue, countdown, friendly], []).
power_trait(arcane_incantation, convert_tiles, [random, basic], [purple]).
...
power_trait(supernova, direct_damage, [all_enemies, all_allies], []).
...
power_trait(world_rupture, direct_damage, [all_enemies, all_allies], []).

power(sentry, dark_avengers, sacrifice, yellow, 8).
power_trait(sacrifice, create_special, [strike, friendly, yellow], []).
...
power_trait(settlement, steal_special, [protect, attack, strike], []).
power_trait(settlement, increase, [friendly, protect, attack, strike], []).
...
power_trait(power_of_attorney, destroy_tiles, [random, block, bottom], []).
...
power_trait(spider_sense, create_special, [protect, friendly, purple], []).
...
power_trait(the_bigger_they_are, create_special, [protect, friendly, yellow], []).
...
power_trait(nuts_from_above, [amplified_by], [enemy, protect, attack, strike], []).

power(squirrel_girl, unbeatable, furry_friends, green, 11).
power_trait(furry_friends, create_special, [countdown, friendly, green], []).
power_trait(furry_friends, direct_damage, [target_enemy], []).
power_trait(furry_friends, destroy_tiles, [random, basic], []).
...
power_trait(something_good, convert_tiles, [enemy_strongest], [charged, green]).
power_trait(something_good, amplified_by, [low_health], []).

power(star_lord, peter_quill, something_bad, purple, 8).
power_trait(something_bad, steal_special, [strike, protect, attack], []).
...
power_trait(bit_of_both, destroy_tiles, [random, column, special, basic, friendly, enemy], []).
...
power_trait(infinite_power, create_special, [countdown, friendly, purple], []).
power_trait(infinite_power, increase, [match_damage], []).

power(thanos, modern, come_and_get_me, green, 12).
power_trait(come_and_get_me, create_special, [countdown, friendly, green], []).
...
power_trait(twin_pistols, destroy_tiles, [targeted, block], []).
...
power_trait(thunderous_clap, destroy_tiles, [random, special, basic, enemy, friendly], []).
...
power_trait(molotov_cocktail, create_special, [repeater, friendly, red], []).
power_trait(molotov_cocktail, create_special, [attack, friendly], []).

power(the_punisher, dark_reign, judgement, green, 8).
power_trait(judgement, destroy_tiles, [random, block], []).
power_trait(judgement, create_special, [strike, friendly, random], []).
...
power_trait(density_heavy, create_special, [countdown, friendly, blue], []).
power_trait(density_heavy, increase, [damage, self], []).
...
power_trait(attack_protocol, destroy_tiles, [random, block], []).
power_trait(attack_protocol, remove_special, [strike, protect, attack, enemy], []).

power(vision, android_avenger, density_light, yellow, 5).
power_trait(density_light, create_special, [countdown, friendly, yellow], []).
...
power_trait(berserker_rage, create_special, [strike, friendly, green], []).
power_trait(berserker_rage, create_special, [strike, enemy, purple], []).

power(wolverine, patch, best_there_is, red, 14).
power_trait(best_there_is, direct_damage, [target_enemy], []).
power_trait(best_there_is, create_special, [strike, friendly, red], []).
power_trait(best_there_is, create_special, [strike, enemy, red], []).
